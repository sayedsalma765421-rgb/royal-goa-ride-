...
function toggleDarkMode() {
  ...
  // keep legacy selectors working across the codebase
...
function renderHomePage(list) {
  ...
  return `
    <div class="animate-fade-in">
      ...
      <section class="py-24 bg-slate-950 section-featured">
  ...
  return `
    <div class="vehicle-card ${isDualTransmission ? 'ring-2 ring-blue-400 shadow-lg' : ''}">
      ...
      <div class="p-6 flex flex-col flex-grow">
        ...
        <div class="vehicle-rate-block mb-6">
          <span class="text-sm uppercase tracking-[0.3em] text-slate-500">Per day</span>
          <p class="text-3xl font-black mt-2">₹${vehicle.pricePerDay || 0}</p>
        </div>
